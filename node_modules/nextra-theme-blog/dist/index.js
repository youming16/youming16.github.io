...
function Meta() {
  ...
  const tagsEl = tags.map((t) => /* @__PURE__ */ jsx2(Link, {
    href: "/tags/[tag]",
    as: `/tags/${t}`,
    passHref: true,
    legacyBehavior: true,
        ...
        children: [
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              author,
              author && date && ",",
              date && /* @__PURE__ */ jsx2("time", {
                dateTime: new Date(date).toISOString(),
                children: new Date(date).toDateString()
              }),
              (author || date) && (readingTime || tags.length > 0) && /* @__PURE__ */ jsx2("span", {
                className: "nx-px-1",
                children: "\u2022"
              }),
              readingTime || tagsEl
...
var H1 = ({ children }) => {
  ...
  return /* @__PURE__ */ jsx3(Fragment, {
    children: showHeading && createPortal(children, ref.current)
  });
};
function HeadingLink(_a) {
  ...
  return /* @__PURE__ */ jsxs2(Tag, __spreadProps(__spreadValues({
...
var A = (_a) => {
  ...
  if (isExternal) {
    return /* @__PURE__ */ jsxs2("a", __spreadProps(__spreadValues({
      target: "_blank",
      rel: "noreferrer"
    }, props), {
      children: [
  ...
  return props.href ? /* @__PURE__ */ jsx3(Link2, {
    href: props.href,
    passHref: true,
    legacyBehavior: true,
    children: /* @__PURE__ */ jsx3("a", __spreadProps(__spreadValues({}, props), {
      children
    }))
  }) : null;
};
var useComponents = () => {
  ...
  return __spreadValues({
    h1: H1,
    h2: (props) => /* @__PURE__ */ jsx3(HeadingLink, __spreadValues({
      tag: "h2"
    }, props)),
    h3: (props) => /* @__PURE__ */ jsx3(HeadingLink, __spreadValues({
      tag: "h3"
    }, props)),
    h4: (props) => /* @__PURE__ */ jsx3(HeadingLink, __spreadValues({
      tag: "h4"
    }, props)),
    h5: (props) => /* @__PURE__ */ jsx3(HeadingLink, __spreadValues({
      tag: "h5"
    }, props)),
    h6: (props) => /* @__PURE__ */ jsx3(HeadingLink, __spreadValues({
      tag: "h6"
    }, props)),
    a: A,
    pre: (_a) => {
      ...
      return /* @__PURE__ */ jsx3("div", {
        ...
        children: /* @__PURE__ */ jsx3(Pre, __spreadProps(__spreadValues({}, props), {
          children
        }))
      });
    },
    ...
    th: Th,
    td: Td,
    table: (props) => /* @__PURE__ */ jsx3(Table, __spreadValues({
      className: "nx-not-prose"
    }, props)),
    code: Code
  }, config.components);
...
var MDXTheme = ({
  ...
  return /* @__PURE__ */ jsx3(MDXProvider, {
...
var BasicLayout = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxs3("article", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs3(HeadingContext.Provider, {
        value: ref,
        children: [
          opts.hasJsxInH1 ? /* @__PURE__ */ jsx4("h1", {
            ref
          }) : null,
          opts.hasJsxInH1 ? null : /* @__PURE__ */ jsx4("h1", {
            children: opts.title
          }),
          children,
          config.footer
...
var ArticleLayout = ({ children }) => {
  const { config } = useBlogContext();
  return /* @__PURE__ */ jsxs4(BasicLayout, {
    children: [
      /* @__PURE__ */ jsx5(Meta, {}),
      /* @__PURE__ */ jsxs4(MDXTheme, {
        children: [
          children,
          config.postFooter,
          config.comments
    ...
    children: [
      /* @__PURE__ */ jsxs5("div", {
        ...
        children: [
          ...
          (_a = config.navs) == null ? void 0 : _a.map((nav) => /* @__PURE__ */ jsx6(Link3, {
            href: nav.url,
            passHref: true,
            legacyBehavior: true,
            children: /* @__PURE__ */ jsx6("a", {
...
var PostsLayout = ({ children }) => {
  ...
  const postList = posts.map((post) => {
    ...
    return /* @__PURE__ */ jsxs6("div", {
      ...
      children: [
        ...
        description && /* @__PURE__ */ jsxs6("p", {
          className: "nx-mb-2 nx-text-gray-400",
          children: [
            description,
            config.readMore && /* @__PURE__ */ jsx7(Link4, {
              href: post.route,
              passHref: true,
              legacyBehavior: true,
              children: /* @__PURE__ */ jsx7("a", {
  ...
  return /* @__PURE__ */ jsxs6(BasicLayout, {
    children: [
      /* @__PURE__ */ jsx7(Nav, {}),
      /* @__PURE__ */ jsx7(MDXTheme, {
        children
      }),
      postList
    ]
...
var PageLayout = ({ children }) => {
  return /* @__PURE__ */ jsxs7(BasicLayout, {
    children: [
      /* @__PURE__ */ jsx8(Nav, {}),
      /* @__PURE__ */ jsx8(MDXTheme, {
        children
      })
    ]
  });
...
var BlogLayout = ({
  ...
  return /* @__PURE__ */ jsx9(BlogProvider, {
    opts,
    config,
    children: /* @__PURE__ */ jsx9(Layout2, {
      children
    })
  });
};
function Layout(_a) {
  ...
  return /* @__PURE__ */ jsx9(ThemeProvider, {
    attribute: "class",
    defaultTheme: "system",
    enableSystem: true,
    children: /* @__PURE__ */ jsx9(BlogLayout, {
