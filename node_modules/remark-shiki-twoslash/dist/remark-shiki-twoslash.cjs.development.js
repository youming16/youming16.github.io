...
var fenceparser = require('fenceparser');
...
var cachedTwoslashCall = function cachedTwoslashCall(code, lang, settings) {
  ...
  var codeSha = shasum.update(code + "-" + shikiVersion).digest("hex");
...
var setupNodeForTwoslashException = function setupNodeForTwoslashException(code, node, error) {
  ...
  if (typeof error !== "object") {
    ...
    eLog(error);
  } else if (error instanceof twoslash.TwoslashError) {
...
function getHTML(code, fence, highlighters, twoslash, twoslashSettings) {
  ...
  var results; // Support 'twoslash' includes
  ...
  if (fence.lang === "twoslash") {
    ...
    var output = highlighters.map(function (highlighter) {
      ...
      return shikiTwoslash.renderCodeToHTML(code, fence.lang, fence.meta, _extends({
        themeName: themeName
...
var runTwoSlashOnNode = function runTwoSlashOnNode(code, _ref, settings) {
  ...
  if (shouldDisableTwoslash) return undefined; // Only run twoslash when the meta has the attribute twoslash
...
var parseFence = function parseFence(fence) {
  ...
  var _lex = fenceparser.lex(fence),
      lang = _lex[0],
      tokens = _lex.slice(1); // if the language is twoslash and include key is found
  ...
  var meta = (_parse = fenceparser.parse(tokens)) != null ? _parse : {};
  return {
    lang: (lang || "").toString(),
    meta: meta
  };
...
function remarkTwoslash(settings) {
  ...
  var transform = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(markdownAST) {
      var highlighters;
...
var remarkVisitor = function remarkVisitor(highlighters, twoslashSettings) {
  ...
  return function (node) {
    ...
    try {
      ...
      twoslash$1 = node.twoslash || runTwoSlashOnNode(code, fence, twoslashSettings);
    } catch (error) {
...
var setupForFile = /*#__PURE__*/function () {
  var _ref4 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3(settings) {
    var highlighters;
...
exports.highlightersFromSettings = highlightersFromSettings;
exports.remarkVisitor = remarkVisitor;
exports.runTwoSlashOnNode = runTwoSlashOnNode;
exports.setupForFile = setupForFile;
exports.transformAttributesToHTML = transformAttributesToHTML;
//# sourceMappingURL=remark-shiki-twoslash.cjs.development.js.map
